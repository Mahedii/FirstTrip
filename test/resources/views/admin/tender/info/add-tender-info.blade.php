                    ...
                    <div class="container-fluid">
                       ...
                       <div class="row">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tender Info</a></li>
                        ...
                        <div class="row">
                            ...
                            <form method="POST" action="{{ route('tender.info.insert') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Add Tender Info</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('ORGANIZATION') is-invalid @enderror" value="{{ old('ORGANIZATION') }}" name="ORGANIZATION">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('YEAR') is-invalid @enderror" value="{{ old('YEAR') }}" name="YEAR">
                                                            @if ($errors->has('YEAR'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control @error('PURCHASE_DEADLINE') is-invalid @enderror" value="{{ old('PURCHASE_DEADLINE') }}" name="PURCHASE_DEADLINE">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('TOTAL_PURCHASE_AMOUNT') is-invalid @enderror" value="{{ old('TOTAL_PURCHASE_AMOUNT') }}" name="TOTAL_PURCHASE_AMOUNT">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('TOTAL_ITEMS') is-invalid @enderror" value="{{ old('TOTAL_ITEMS') }}" name="TOTAL_ITEMS" id="TOTAL_ITEMS">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('PURCHASE_QUANTITY') is-invalid @enderror" value="{{ old('PURCHASE_QUANTITY') }}" name="PURCHASE_QUANTITY" id="PURCHASE_QUANTITY">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('PURCHASE_DUE_ITEMS') is-invalid @enderror" value="{{ old('PURCHASE_DUE_ITEMS') }}" name="PURCHASE_DUE_ITEMS" id="PURCHASE_DUE_ITEMS">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('DELIVERY_ITEMS') is-invalid @enderror" value="{{ old('DELIVERY_ITEMS') }}" name="DELIVERY_ITEMS" id="DELIVERY_ITEMS">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('ITEMS_DELIVERY_DUE') is-invalid @enderror" value="{{ old('ITEMS_DELIVERY_DUE') }}" name="ITEMS_DELIVERY_DUE" id="ITEMS_DELIVERY_DUE">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            <label for="DELIVERY_ADDRESS" class="form-label">Description <span class="text-danger">*</span></label>
                                        ...
                                        <div class="text-end mb-3">
                                            <button type="submit" class="btn btn-success w-sm">Add Tender Info</button>
                                        </div>
                                    </div>
                                    <!-- end col -->
