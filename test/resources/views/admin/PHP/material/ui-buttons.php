...
<head>
    ...
    <title>Buttons | Velzon - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the<code> btn</code> class to show the default button style.
                                </p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button"
                                            class="btn btn-outline-primary waves-effect waves-light shadow-none">Primary</button>
                                        <button type="button"
                                            class="btn btn-outline-secondary waves-effect waves-light shadow-none">Secondary</button>
                                        <button type="button"
                                            class="btn btn-outline-success waves-effect waves-light shadow-none">Success</button>
                                        <button type="button"
                                            class="btn btn-outline-info waves-effect waves-light shadow-none">Info</button>
                                        <button type="button"
                                            class="btn btn-outline-warning waves-effect waves-light shadow-none">Warning</button>
                                        <button type="button"
                                            class="btn btn-outline-danger waves-effect waves-light shadow-none">Danger</button>
                                        <button type="button"
                                            class="btn btn-outline-dark waves-effect waves-light shadow-none">Dark</button>
                                        <button type="button"
                                            class="btn btn-outline-light waves-effect shadow-none">Light</button>
                                    </div>
                                </div>
                                <div class="d-none code-view">
                                    <pre class="language-markup"
                                        style="height: 275px;"><code>&lt;!-- Outline Buttons --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-primary waves-effect waves-light shadow-none&quot;&gt;Primary&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-secondary waves-effect waves-light shadow-none&quot;&gt;Secondary&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-success waves-effect waves-light shadow-none&quot;&gt;Success&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-info waves-effect waves-light shadow-none&quot;&gt;Info&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-warning waves-effect waves-light shadow-none&quot;&gt;Warning&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-danger waves-effect waves-light shadow-none&quot;&gt;Danger&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-dark waves-effect waves-light shadow-none&quot;&gt;Dark&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-light waves-effect shadow-none&quot;&gt;Light&lt;/button&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-21">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the <code>rounded-pill </code>class to make a rounded button.
                                </p>
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button"
                                        ...
                                        <button type="button"
                                            class="btn rounded-pill btn-secondary waves-effect waves-light">Secondary</button>
                                        <button type="button"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button"
                                            class="btn btn-soft-primary waves-effect waves-light shadow-none">Primary</button>
                                        <button type="button"
                                            class="btn btn-soft-secondary waves-effect waves-light shadow-none">Secondary</button>
                                        <button type="button"
                                            class="btn btn-soft-success waves-effect waves-light shadow-none">Success</button>
                                        <button type="button"
                                            class="btn btn-soft-info waves-effect waves-light shadow-none">Info</button>
                                        <button type="button"
                                            class="btn btn-soft-warning waves-effect waves-light shadow-none">Warning</button>
                                        <button type="button"
                                            class="btn btn-soft-danger waves-effect waves-light shadow-none">Danger</button>
                                        <button type="button"
                                            class="btn btn-soft-dark waves-effect waves-light shadow-none">Dark</button>
                                    </div>
                                </div>
                                <div class="d-none code-view">
                                    <pre class="language-markup"
                                        style="height: 275px;"><code>&lt;!-- Soft Buttons --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-primary waves-effect waves-light shadow-none&quot;&gt;Primary&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-secondary waves-effect waves-light shadow-none&quot;&gt;secondary&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-success waves-effect waves-light shadow-none&quot;&gt;Success&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-info waves-effect waves-light shadow-none&quot;&gt;Info&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-warning waves-effect waves-light shadow-none&quot;&gt;Warning&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-danger waves-effect waves-light shadow-none&quot;&gt;Danger&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-soft-dark waves-effect waves-light shadow-none&quot;&gt;Dark&lt;/button&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button"
                                            class="btn btn-ghost-primary waves-effect waves-light shadow-none">Primary</button>
                                        <button type="button"
                                            class="btn btn-ghost-secondary waves-effect waves-light shadow-none">Secondary</button>
                                        <button type="button"
                                            class="btn btn-ghost-success waves-effect waves-light shadow-none">Success</button>
                                        <button type="button"
                                            class="btn btn-ghost-info waves-effect waves-light shadow-none">Info</button>
                                        <button type="button"
                                            class="btn btn-ghost-warning waves-effect waves-light shadow-none">Warning</button>
                                        <button type="button"
                                            class="btn btn-ghost-danger waves-effect waves-light shadow-none">Danger</button>
                                        <button type="button"
                                            class="btn btn-ghost-dark waves-effect waves-light shadow-none">Dark</button>
                                    </div>
                                </div>
                                <div class="d-none code-view">
                                    <pre class="language-markup"
                                        style="height: 275px;"><code>&lt;!-- ghost Buttons --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-primary waves-effect waves-light shadow-none&quot;&gt;Primary&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-secondary waves-effect&quot;&gt;secondary&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-success waves-effect waves-light shadow-none&quot;&gt;Success&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-info waves-effect waves-light shadow-none&quot;&gt;Info&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-warning waves-effect waves-light shadow-none&quot;&gt;Warning&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-danger waves-effect waves-light shadow-none&quot;&gt;Danger&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-ghost-dark waves-effect waves-light shadow-none&quot;&gt;Dark&lt;/button&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use <code>bg-gradient </code>class to create a gradient button.
                                </p>
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button"
                                        ...
                                        <button type="button"
                                            class="btn btn-light bg-gradient waves-effect">Light</button>
                                    </div>
                                </div>
                                <div class="d-none code-view">
                                    <pre
...
<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-light bg-gradient waves-effect&quot;&gt;Light&lt;/button&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use <code>bg-animation </code>class to create an animated button.
                                </p>
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button"
                                ...
                                <div class="live-preview">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                <button type="button"
                                                    class="btn btn-primary btn-label rounded-pill waves-effect waves-light"><i
                                                ...
                                                <button type="button"
                                                    ...
                                                    Success</button>
                                                <button type="button"
                                                    class="btn btn-warning btn-label rounded-pill waves-effect waves-light"><i
                                        ...
                                        <div class="col-lg-4">
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="button"
                                                    class="btn btn-primary btn-label waves-effect waves-light right"><i
                                                        class="ri-user-smile-line label-icon align-middle fs-16 ms-2"></i>
                                                    Primary</button>
                                                <button type="button"
                                                    class="btn btn-success btn-label waves-effect waves-light right rounded-pill"><i
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <label for="custom-toggle-button" class="form-label text-muted">Show
                                            Code</label>
                                        <input class="form-check-input code-switcher" type="checkbox"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                ...
                                                <button type="button" class="btn btn-secondary custom-toggle active"
                                                    ...
                                                    <span class="icon-on"><i
                                                            class="ri-user-add-line align-bottom me-1"></i>
                                                        Connect</span>
                                                    <span class="icon-off"><i
                                                            class="ri-check-fill align-bottom me-1"></i>
                                                        Unconnect</span>
                                                </button>
                                                <button type="button" class="btn btn-success custom-toggle"
                                                    data-bs-toggle="button">
                                                    <span class="icon-on"><i
                                                ...
                                                <button type="button" class="btn btn-danger custom-toggle"
                                                    data-bs-toggle="button">
                                                    <span class="icon-on">On</span>
                                                    <span class="icon-off">Off</span>
                                                </button>
                                                <button type="button" class="btn btn-dark custom-toggle"
                                                    data-bs-toggle="button">
                                                    <span class="icon-on"><i
                                                            class="ri-bookmark-line align-bottom me-1"></i>
                                                        Bookmark</span>
                                                    <span class="icon-off"><i
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                ...
                                                <button type="button"
                                                    class="btn btn-outline-success custom-toggle active"
                                                    data-bs-toggle="button">
                                                    <span class="icon-on">On</span>
                                                    <span class="icon-off">Off</span>
                                                </button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap align-items-center gap-2">
                                        <!-- Large Button -->
                                        <button type="button"
                                            class="btn btn-primary btn-lg waves-effect waves-light">Large
                                            button</button>
                                        <button type="button" class="btn btn-light btn-lg waves-effect">Large
                                            button</button>

                                        <!-- Small Button -->
                                        <button type="button"
                                            class="btn btn-primary btn-sm waves-effect waves-light">Small
                                            button</button>
                                        <button type="button" class="btn btn-light btn-sm waves-effect">Small
                                            button</button>
                                    </div>
                                </div>
                                <div class="d-none code-view">
                                    <pre class="language-markup">
<code>&lt;!-- Large Button --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-primary btn-lg waves-effect waves-light&quot;&gt;Large button&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-light btn-lg waves-effect&quot;&gt;Large button&lt;/button&gt;</code>

<code>&lt;!-- Small Button --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-primary btn-sm waves-effect waves-light&quot;&gt;Small button&lt;/button&gt;</code>

<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-light btn-sm waves-effect&quot;&gt;Small button&lt;/button&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use <code>w-xs,w-sm,w-md,w-lg</code> class to make different sized
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use <code>btn</code> class with different HTML elements. (though
                                    some browsers may apply a slightly different rendering)<p>
                                        <div class="live-preview">
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <input class="btn btn-info waves-effect waves-light" type="button"
                                                    value="Input">
                                                <input class="btn btn-danger waves-effect waves-light" type="submit"
                                                    value="Submit">
                                                <input class="btn btn-warning waves-effect waves-light" type="reset"
                                                    value="Reset">
                                            </div>
                                        </div>
                                        <div class="d-none code-view">
                                            <pre
                                                class="language-markup"><code>&lt;!-- Tag Button --&gt;
...
<code>&lt;input class=&quot;btn btn-info waves-effect waves-light&quot; type=&quot;button&quot; value=&quot;Input&quot;&gt;</code>

<code>&lt;input class=&quot;btn btn-danger waves-effect waves-light&quot; type=&quot;submit&quot; value=&quot;Submit&quot;&gt;</code>

<code>&lt;input class=&quot;btn btn-warning waves-effect waves-light&quot; type=&quot;reset&quot; value=&quot;Reset&quot;&gt;</code></pre>
                                        </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                            ...
                            <div class="card-body">
                                <p class="text-muted">
                                    Combine button-like <code>checkbox and radio</code> <a
                                        href="https://getbootstrap.com/docs/5.1/forms/checks-radios/">toggle buttons</a>
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap align-items-center gap-2">
                                        <div class="btn-group shadow" role="group"
                                            ...
                                            <label class="btn btn-primary shadow-none mb-0" for="btncheck1">Checkbox
                                                1</label>

                                            <input type="checkbox" class="btn-check" id="btncheck2">
                                            <label class="btn btn-primary shadow-none mb-0" for="btncheck2">Checkbox
                                                2</label>

                                            <input type="checkbox" class="btn-check" id="btncheck3">
                                            <label class="btn btn-primary shadow-none mb-0" for="btncheck3">Checkbox
                                                3</label>
                                        </div>
                                        ...
                                        <div class="btn-group" role="group"
                                            ...
                                            <input type="radio" class="btn-check" name="btnradio" id="btnradio1"
                                                checked="">
                                            <label class="btn btn-outline-secondary shadow-none mb-0"
                                                for="btnradio1">Radio 1</label>

                                            <input type="radio" class="btn-check" name="btnradio" id="btnradio2">
                                            <label class="btn btn-outline-secondary shadow-none mb-0"
                                                for="btnradio2">Radio 2</label>
...
&lt;div class=&quot;btn-group shadow&quot; role=&quot;group&quot; aria-label=&quot;Basic checkbox toggle button group&quot;&gt;
    &lt;input type=&quot;checkbox&quot; class=&quot;btn-check&quot; id=&quot;btncheck1&quot; autocomplete=&quot;off&quot; checked=&quot;&quot;&gt;
    &lt;label class=&quot;btn btn-primary shadow-none&quot; for=&quot;btncheck1&quot;&gt;Checkbox 1&lt;/label&gt;
    
    &lt;input type=&quot;checkbox&quot; class=&quot;btn-check&quot; id=&quot;btncheck2&quot; autocomplete=&quot;off&quot;&gt;
    &lt;label class=&quot;btn btn-primary shadow-none&quot; for=&quot;btncheck2&quot;&gt;Checkbox 2&lt;/label&gt;
    
    &lt;input type=&quot;checkbox&quot; class=&quot;btn-check&quot; id=&quot;btncheck3&quot; autocomplete=&quot;off&quot;&gt;
    &lt;label class=&quot;btn btn-primary shadow-none&quot; for=&quot;btncheck3&quot;&gt;Checkbox 3&lt;/label&gt;
&lt;/div&gt;</code>

<code>&lt;!-- Radio Buttons --&gt;
&lt;div class=&quot;btn-group&quot; role=&quot;group&quot; aria-label=&quot;Basic radio toggle button group&quot;&gt;
    &lt;input type=&quot;radio&quot; class=&quot;btn-check&quot; name=&quot;btnradio&quot; id=&quot;btnradio1&quot; autocomplete=&quot;off&quot; checked=&quot;&quot;&gt;
    &lt;label class=&quot;btn btn-outline-secondary shadow-none&quot; for=&quot;btnradio1&quot;&gt;Radio 1&lt;/label&gt;

    &lt;input type=&quot;radio&quot; class=&quot;btn-check&quot; name=&quot;btnradio&quot; id=&quot;btnradio2&quot; autocomplete=&quot;off&quot;&gt;
    &lt;label class=&quot;btn btn-outline-secondary shadow-none&quot; for=&quot;btnradio2&quot;&gt;Radio 2&lt;/label&gt;

    &lt;input type=&quot;radio&quot; class=&quot;btn-check&quot; name=&quot;btnradio&quot; id=&quot;btnradio3&quot; autocomplete=&quot;off&quot;&gt;
    &lt;label class=&quot;btn btn-outline-secondary shadow-none&quot; for=&quot;btnradio3&quot;&gt;Radio 3&lt;/label&gt;
&lt;/div&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Use the <code>btn-group </code> class in the parent class to wrap
                                    a series of buttons.</p>
                                <div class="live-preview">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="btn-group shadow" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light shadow-none">Left</button>
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light shadow-none">Middle</button>
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light shadow-none">Right</button>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-sm-6">
                                            <div class="btn-group shadow mt-4 mt-sm-0" role="group"
                                                aria-label="Basic example">
                                                <button type="button"
                                                    class="btn btn-light btn-icon waves-effect shadow-none"><i
...
<code>&lt;!-- Buttons Group --&gt;
&lt;div class=&quot;btn-group shadow&quot; role=&quot;group&quot; aria-label=&quot;Basic example&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-primary waves-effect waves-light shadow-none&quot;&gt;Left&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-primary waves-effect waves-light shadow-none&quot;&gt;Middle&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-primary waves-effect waves-light shadow-none&quot;&gt;Right&lt;/button&gt;
&lt;/div&gt;</code>

<code>&lt;div class=&quot;btn-group shadow&quot; role=&quot;group&quot; aria-label=&quot;Basic example&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-light btn-icon waves-effect shadow-none&quot;&gt;&lt;i class=&quot;ri-align-right&quot;&gt;&lt;/i&gt;&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-light btn-icon waves-effect shadow-none&quot;&gt;&lt;i class=&quot;ri-align-center&quot;&gt;&lt;/i&gt;&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-light btn-icon waves-effect shadow-none&quot;&gt;&lt;i class=&quot;ri-align-left&quot;&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="hstack gap-2 mt-4 mt-sm-0">
                                                <button type="button"
                                                    class="btn btn-outline-primary btn-icon waves-effect waves-light shadow-none"><i
                                                        class="ri-24-hours-fill"></i></button>
                                                <button type="button"
                                                    class="btn btn-outline-danger btn-icon waves-effect waves-light shadow-none"><i
                                                        class="ri-customer-service-2-line"></i></button>
                                                <button type="button"
                                                    class="btn btn-outline-success btn-icon waves-effect waves-light shadow-none"><i
                                                        class="ri-mail-send-line"></i></button>
                                                <button type="button"
                                                    class="btn btn-outline-warning btn-icon waves-effect waves-light shadow-none"><i
...
<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-primary btn-icon waves-effect waves-light shadow-none&quot;&gt;&lt;i class=&quot;ri-24-hours-fill&quot;&gt;&lt;/i&gt;&lt;/button&gt;</code>
<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-danger btn-icon waves-effect waves-light shadow-none&quot;&gt;&lt;i class=&quot;ri-customer-service-2-line&quot;&gt;&lt;/i&gt;&lt;/button&gt;</code>
<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-success btn-icon waves-effect waves-light shadow-none&quot;&gt;&lt;i class=&quot;ri-mail-send-line&quot;&gt;&lt;/i&gt;&lt;/button&gt;</code>
<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-warning btn-icon waves-effect waves-light shadow-none&quot;&gt;&lt;i class=&quot;ri-menu-2-line&quot;&gt;&lt;/i&gt;&lt;/button&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                            <div class="btn-group shadow me-2" role="group" aria-label="First group">
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">1</button>
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">2</button>
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">3</button>
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">4</button>
                                            </div>
                                            <div class="btn-group shadow me-2" role="group" aria-label="Second group">
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">5</button>
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">6</button>
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">7</button>
                                            </div>
                                            <div class="btn-group shadow" role="group" aria-label="Third group">
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">8</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap align-items-center gap-2">
                                        ...
                                        <div class="btn-group mt-2 shadow" role="group" aria-label="Basic example">
                                            <button type="button"
                                                class="btn btn-light waves-effect shadow-none">Left</button>
                                            <button type="button"
                                                class="btn btn-light waves-effect shadow-none">Middle</button>
                                            <button type="button"
                                                class="btn btn-light waves-effect shadow-none">Right</button>
                                        </div>
                                        <div class="btn-group btn-group-sm mt-2 shadow" role="group"
                                            aria-label="Basic example">
                                            <button type="button"
                                                class="btn btn-secondary waves-effect waves-light shadow-none">Left</button>
                                            <button type="button"
                                                class="btn btn-secondary waves-effect waves-light shadow-none">Middle</button>
                                            <button type="button"
                                                class="btn btn-secondary waves-effect waves-light shadow-none">Right</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-none code-view">
...
<code>&lt;div class=&quot;btn-group shadow&quot; role=&quot;group&quot; aria-label=&quot;Basic example&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-light waves-effect shadow-none"&quot;&gt;Left&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-light waves-effect shadow-none"&quot;&gt;Middle&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-light waves-effect shadow-none"&quot;&gt;Right&lt;/button&gt;
&lt;/div&gt;</code>

<code>&lt;div class=&quot;btn-group btn-group-sm shadow&quot; role=&quot;group&quot; aria-label=&quot;Basic example&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary waves-effect waves-light shadow-none&quot;&gt;Left&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary waves-effect waves-light shadow-none&quot;&gt;Middle&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary waves-effect waves-light shadow-none&quot;&gt;Right&lt;/button&gt;
&lt;/div&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="btn-group shadow" role="group"
                                                ...
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light shadow-none">1</button>
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light shadow-none">2</button>
                                                <div class="btn-group" role="group">
                                                    <button id="btnGroupDrop1" type="button"
                                                        class="btn btn-primary waves-effect waves-light shadow-none dropdown-toggle"
                                        ...
                                        <div class="col-auto">
                                            <div class="btn-group-vertical shadow" role="group"
                                                ...
                                                <button type="button"
                                                    class="btn btn-light waves-effect shadow-none">Button</button>
                                                <div class="btn-group" role="group">
                                                    <button id="btnGroupVerticalDrop1" type="button"
                                                        class="btn btn-light waves-effect shadow-none dropdown-toggle"
