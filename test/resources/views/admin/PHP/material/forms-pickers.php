                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3">
                                                ...
                                                <p class="text-muted">Set <code>data-provider="flatpickr"
                                                        data-date-format="d M, Y" data-minDate="Your Min. Date"
                                                        data-maxDate="Your Max. date"</code> attribute.</p>
                                                <input type="text" class="form-control" data-provider="flatpickr"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-3">
                                                ...
                                                <p class="text-muted">Set <code>data-provider="flatpickr"
                                                        data-date-format="d M, Y" data-deafult-date="Your Default
                                                        Date"</code> attribute.</p>
                                                <input type="text" class="form-control" data-provider="flatpickr"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3">
                                                ...
                                                <p class="text-muted">Set <code>data-provider="flatpickr"
                                                        data-disable="true"</code> attribute.</p>
                                                <input type="text" class="form-control" data-provider="flatpickr"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-3">
                                                ...
                                                <p class="text-muted">Set <code>data-provider="flatpickr"
                                                        data-date-format="d M, Y" data-multiple-date="true"</code>
                                                    attribute.</p>
                                                <input type="text" class="form-control" data-provider="flatpickr"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3">
                                                ...
                                                <p class="text-muted">Set <code>data-provider="flatpickr"
                                                        data-date-format="d M, Y" data-range-date="true"</code>
                                                    attribute.</p>
                                                <input type="text" class="form-control" data-provider="flatpickr"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-3">
                                                ...
                                                <p class="text-muted">Set <code>data-provider="timepickr"
                                                        data-min-time="Min.Time" data-max-time="Max.Time"</code>
                                                    attribute.</p>
                                                <input type="text" class="form-control" data-provider="timepickr"
                                        ...
                                        <div class="row g-4">
                                            <div class="col-lg-4 col-md-6">
                                                <div>
                                                    ...
                                                    <p class="text-muted">Use <code>classic-colorpicker</code> class to
                                                        set classic colorpicker.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div>
                                                    ...
                                                    <p class="text-muted">Use <code>monolith-colorpicker</code> class to
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div>
                                                    ...
                                                    <p class="text-muted">Use <code>nano-colorpicker</code> class to set
                                                        nano colorpicker.</p>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mt-2">
                                                    ...
                                                    <p class="text-muted">Use <code>colorpicker-demo</code> class to set
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mt-2">
                                                    ...
                                                    <p class="text-muted">Use <code>colorpicker-opacity-hue</code> class
                                                        to set colorpicker with opacity & hue.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mt-2">
                                                    ...
                                                    <p class="text-muted">Use <code>colorpicker-switch</code> class to
                                                        set switch colorpicker.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mt-2">
                                                    ...
                                                    <p class="text-muted">Use <code>colorpicker-input</code> class to
                                                        set colorpicker with input.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mt-2">
                                                    ...
                                                    <p class="text-muted">Use <code>colorpicker-format</code> class to
                                                        set colorpicker with format option.</p>
