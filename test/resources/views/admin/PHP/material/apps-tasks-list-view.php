                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="id"><a href="apps-tasks-details.php" class="fw-medium link-primary">#VLZ501</a></td>
                                                        <td class="project_name"><a href="apps-projects-overview.php" class="fw-medium link-primary">Velzon -
                                                                v1.0.0</a></td>
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-shrink-0 ms-4">
                                                                    <ul class="list-inline tasks-list-menu mb-0">
                                                                        <li class="list-inline-item"><a href="apps-tasks-details.php"><i
