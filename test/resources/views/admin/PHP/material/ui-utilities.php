...
<head>
    ...
    <title>Utilities | Velzon - Admin & Dashboard Template</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Use border utilities to add or remove an element’s borders. Choose
                                ...
                                <div class="live-preview">
                                    <div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-4">
                                                <div class="text-center">
                                                    <div class="border border-primary avatar-md bg-light mx-auto mb-1">
                                                    </div>
                                                    <p><code>.border-primary</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <div
                                                        class="border border-secondary avatar-md bg-light mx-auto mb-1">
                                                    </div>
                                                    <p><code>.border-secondary</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <div class="border border-success avatar-md bg-light mx-auto mb-1">
                                                    </div>
                                                    <p><code>.border-success</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <div class="border border-info avatar-md bg-light mx-auto mb-1">
                                                    </div>
                                                    <p><code>.border-info</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <div class="border border-warning avatar-md bg-light mx-auto mb-1">
                                                    </div>
                                                    <p><code>.border-warning</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <div class="border border-danger avatar-md bg-light mx-auto mb-1">
                                                    </div>
                                                    <p><code>.border-danger</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <div class="border border-dark avatar-md bg-light mx-auto mb-1">
                                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use below-mentioned class to an element to easily round its
                                    corners.</p>
                                <div class="live-preview">
                                    <div>
                                        <div>
                                            <div class="d-flex align-items-start flex-wrap gap-4">
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-2.jpg"
                                                        class="avatar-md rounded shadow" alt="rounded">
                                                    <p><code>.rounded</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-2.jpg"
                                                        class="avatar-md rounded-top shadow" alt="rounded-top">
                                                    <p><code>.rounded-top</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-2.jpg"
                                                        class="avatar-md rounded-end shadow" alt="rounded-end">
                                                    <p><code>.rounded-end</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-2.jpg"
                                                        class="avatar-md rounded-bottom shadow" alt="rounded-bottom">
                                                    <p><code>.rounded-bottom</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-2.jpg"
                                                        class="avatar-md rounded-start shadow" alt="rounded-start">
                                                    <p><code>.rounded-start</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-2.jpg"
                                                        class="avatar-md rounded-circle shadow" alt="rounded-circle">
                                                ...
                                                <div class="text-center">
                                                    <img src="assets/images/small/img-2.jpg"
                                                        class="avatar-md w-auto rounded-pill shadow" alt="rounded-pill">
                                            ...
                                            <div class="d-flex align-items-start flex-wrap gap-4">
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-1.jpg"
                                                        class="avatar-md rounded-0 shadow" alt="rounded-0">
                                                    <p><code>.rounded-0</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-1.jpg"
                                                        class="avatar-md rounded-1 shadow" alt="rounded-1">
                                                    <p><code>.rounded-1</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-1.jpg"
                                                        class="avatar-md rounded-2 shadow" alt="rounded-2">
                                                    <p><code>.rounded-2</code></p>
                                                </div>
                                                <div class="text-center">
                                                    <img src="assets/images/users/avatar-1.jpg"
                                                        class="avatar-md rounded-3 shadow" alt="rounded-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use below-mentioned class to an element to display the value of
                                ...
                                <div class="live-preview">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <p class="text-muted">Change the display value of elements when printing with
                                            our print display utility classes.</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the below-mentioned class to an element to custom display the
                                    value of components and more with our display utilities.</p>
                                <div class="live-preview">
                                    <div>
                                        <div class="table-responsive">
                ...
                <div class="row">
                    <div class="col-xxl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted mb-3">Use <code>vstack</code> class to create vertical layouts.
                                    Stacked items are full-width by default. Use <code>gap-</code> class with variation
                                    to add space between items.</p>
                                <div class="live-preview">
                                    <div class="vstack gap-3">
                                        <div class="bg-light border shadow p-1 px-2">First item</div>
                                        <div class="bg-light border shadow p-1 px-2">Second item</div>
                                        <div class="bg-light border shadow p-1 px-2">Third item</div>
                                    </div>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="vstack gap-2 col-md-5 mx-auto">
                                            ...
                                            <button type="button"
                                                class="btn btn-outline-secondary shadow-none">Cancel</button>
                                        </div>
                                    </div>
                                </div>
...
<code>&lt;div class=&quot;vstack gap-2&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot;&gt;Save changes&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-outline-secondary shadow-none&quot;&gt;Cancel&lt;/button&gt;
&lt;/div&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <label for="stackshorizontal-showcode" class="form-label text-muted">Show
                                            Code</label>
                                        <input class="form-check-input code-switcher" type="checkbox"
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-3">Use <code>hstack</code> class to create horizontal layouts.
                                    Stacked items are full-width by default. Use <code>gap-</code> class with variation
                                    to add space between items.</p>
                                ...
                                <div class="live-preview">
                                    ...
                                    <div class="mt-4">
                                        <p class="text-muted mb-3">Using horizontal margin utilities like
                                            <code>ms-auto</code> as spacers:</p>

                                        <div class="hstack gap-3">
                                            <div class="bg-light border shadow p-1 px-2">First item</div>
                                            <div class="bg-light border shadow p-1 px-2 ms-auto">Second item</div>
                                            <div class="bg-light border shadow p-1 px-2">Third item</div>
                                        </div>
                                        <div class="hstack gap-3 mt-3">
                                            ...
                                            <div class="bg-light border shadow p-1 px-2 ms-auto">Third item</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="hstack gap-3">
                                            ...
                                            <div class="vr"></div>
                                            <button type="button"
                                                class="btn btn-outline-secondary shadow-none">Reset</button>
                                        </div>
                                    </div>
                                </div>
...
<code>&lt;div class=&quot;hstack gap-3&quot;&gt; 
    ...
    &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot;&gt;Submit&lt;/button&gt;
    &lt;div class=&quot;vr&quot;&gt;&lt;/div&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-outline-secondary shadow-none&quot;&gt;Reset&lt;/button&gt;
&lt;/div&gt;</code></pre>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <label for="textselection-showcode" class="form-label text-muted">Show
                                            Code</label>
                                        <input class="form-check-input code-switcher" type="checkbox"
                            ...
                            <div class="card-body">
                                <p class="text-muted mb-3">Use <code>user-select-all</code>,
                                    <code>user-select-auto</code>, or <code>user-select-none</code> class to the content
                                    which is selected when the user interacts with it.</p>
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <label for="pointnerevents-showcode" class="form-label text-muted">Show
                                            Code</label>
                                        <input class="form-check-input code-switcher" type="checkbox"
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-3">Use <code>pe-none</code> class to prevent and
                                    <code>pe-auto</code> class to add element interactions respectively.</p>

                                <div class="live-preview">
                                    <div>
                                        <p><a href="#" class="text-success pe-none" tabindex="-1">This link</a> can not
                                            be clicked.</p>
                                        <p><a href="#" class="text-success pe-auto">This link</a> can be clicked (this
                                            is default behavior).</p>
                                        <p class="pe-none mb-0"><a href="#" class="text-success" tabindex="-1">This
                                                link</a> can not be clicked because the <code>pointer-events</code>
                                            property is inherited from its parent. However, <a href="#"
                                                class="pe-auto">this link</a> has a <code>pe-auto</code> class and can
                                            be clicked.</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Use <code>overflow</code> property on the fly with four default
                                    values and classes.</p>
                                <div class="live-preview">
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4 mt-xl-0">
                                                    ...
                                                    <div class="d-md-flex bg-light">
                                                        <div class="overflow-hidden p-3 mb-0 bg-light"
                                                            style="height: 100px;">
                                                            This is an example of using <code>.overflow-hidden</code> on
                                                            an element with set width and height dimensions. Lorem ipsum
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4 mt-xl-0">
                                                    ...
                                                    <div class="d-md-flex bg-light">
                                                        <div class="overflow-visible p-3 mb-0 bg-light"
                                                            style="height: 100px;">
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4 mt-xl-0">
                                                    ...
                                                    <div class="d-md-flex bg-light">
                                                        <div class="overflow-scroll p-3 mb-0 bg-light"
                                                            style="height: 100px;">
                            ...
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        ...
                                        <input class="form-check-input code-switcher" type="checkbox"
                                            id="position-showcode">
                                    </div>
                                </div>
                            </div><!-- end card header -->

                            <div class="card-body">
                                <p class="text-muted">Use below mentioned classes to arrange elements easily with the
                                    edge positioning utilities.The format is {property}-{position}.</p>
                                <div class="live-preview">
                                    <div>
                                        <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use
                                    ...
                                    <code>75%</code>, <code>100%</code>, or <code>auto</code> by default respectively.
                                </p>
                                <div class="live-preview">
                                    <div>
