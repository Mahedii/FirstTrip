        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="apps-nft-wallet.php" class="btn btn-success">Wallet Connect</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <a href="apps-nft-create.php" class="btn btn-primary">Create Own <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                                <a href="apps-nft-explore.php" class="btn btn-danger">Explore Now <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!-- end row -->
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border">
                            <div class="card-body py-5 px-4">
                                ...
                                <h5>Metamask</h5>
                                <p class="text-muted pb-1 fs-13">MetaMask is a popular cryptocurrency wallet known for its ease of use, availability on both desktops./p>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border">
                            <div class="card-body py-5 px-4">
                                ...
                                <p class="text-muted pb-1 fs-13">Coinbase Wallet is a self-custody wallet that gives you complete control of your crypto for your Wallet.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border">
                            <div class="card-body py-5 px-4">
                                ...
                                <h5>Binance</h5>
                                <p class="text-muted pb-1 fs-13">Binance is considered a safe exchange that allows user account protection via the use of Two Authentication.</p>
                                <a href="#!" class="btn btn-soft-info">Connect Wallet</a>
                            </div>
                        </div>
                    </div><!-- end col -->
                    ...
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Creative Filtered Portrait</a></h5>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Long-tailed Macaque</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Robotic Body Art</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <a href="apps-nft-explore.php" class="btn btn-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div>
                </div><!-- end row -->
                <div class="row">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Patterns arts &amp; culture</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Long-tailed macaque</a></h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            <a href="apps-nft-create.php" class="btn bg-gradient btn-danger">Create NFT</a>
                            <a href="apps-nft-explore.php" class="btn bg-gradient btn-info">Discover More</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                    ...
                    <div class="col-lg-7 ms-lg-auto">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><a href="pages-pricing.php">Calendar</a></li>
                                        <li><a href="apps-mailbox.php">Mailbox</a></li>
                                        <li><a href="apps-chat.php">Chat</a></li>
                                        <li><a href="apps-crm-deals.php">Deals</a></li>
                                        <li><a href="apps-tasks-kanban.php">Kanban Board</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-4 mt-4">
