                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            <div data-input-flag data-option-flag-name>
                                                <input type="text" class="form-control rounded-end flag-input" readonly
                                                    placeholder="Select country" data-bs-toggle="dropdown"
                                                    aria-expanded="false" />
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div data-input-flag data-option-flag-img-name>
                                                <input type="text" class="form-control rounded-end flag-input" readonly
                                                    value="United States" placeholder="Select country"
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            <label class="form-label">Select input with buttons & Flag with
                                                number</label>
                                            <div class="input-group" data-input-flag>
                                                <button class="btn btn-light border" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false"><img
                                                        src="assets/images/flags/us.svg" alt="flag img" height="20"
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="autoCompleteCars" class="text-muted">Search Result of Car
                                                    Names</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div>
                                            ...
                                            <form>
                                                <select required multiple="multiple" name="favorite_fruits"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-4 mt-lg-0">
                                            ...
                                            <form>
                                                <select required multiple="multiple" name="favorite_cars"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <form>
                                                <select multiple="multiple" name="favorite_cars"
