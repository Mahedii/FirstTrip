...
<head>
    ...
    <title>Badges | Velzon - Admin & Dashboard Template</title>
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Use the <code>badge-soft-</code> class with the below-mentioned
                ...
                <div class="row">
                    <div class="col-xxl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Use the <code>badge-outline-</code> class with the below-mentioned
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Use the <code>rounded-pill badge-soft-</code> class with the
                                    below-mentioned variation
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">
                                    Use the <code>badge-border</code> and <code>badge-soft-</code> with below mentioned
                                    modifier classes to make badges with border & soft backgorund.
                                </p>
                                <div class="live-preview">
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <span class="badge badge-label bg-dark"><i class="mdi mdi-circle-medium"></i>
                                            Dark</span>

                                        <span class="badge badge-label bg-light text-dark"><i
                                                class="mdi mdi-circle-medium"></i> Light</span>
                                    </div>
                                </div>
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <label for="button-position-badges" class="form-label text-muted">Show
                                            Code</label>
                                        <input class="form-check-input code-switcher" type="checkbox"
                                            id="button-position-badges">
                                    </div>
                                </div>
                            </div><!-- end card header -->
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">Use the below utilities to modify a badge and position it in the
...
<code>&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-secondary shadow-none&quot;&gt;
    Draft &lt;span class=&quot;badge bg-success ms-1&quot;&gt;2&lt;/span&gt;
&lt;/button&gt;
</code></pre>
                                </div>
