                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                                                ...
                                                <tbody class="list form-check-all" id="ticket-list-data">
                                                    <tr>
                                                        ...
                                                        <td class="id"><a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="001"
                                                                class="fw-medium link-primary ticket-id">#VLZ001</a></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li><button class="dropdown-item" onclick="location.href = 'apps-tickets-details.php';"><i
                                                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</button></li>
