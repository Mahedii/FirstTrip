                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle table-nowrap table-hover" id="customerTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                                <td class="ranking text-success fw-semibold">
                                                    #1
                                                </td>
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/img-01.jpg" alt=""
                                                            ...
                                                            href="apps-nft-item-details.php" class="link-dark">Abstract
                                                            Face Painting</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/gif/img-1.gif" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php" class="link-dark">Patterns
                                                            Arts & Culture</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/img-02.jpg" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php" class="link-dark">Creative
                                                            Filtered Portrait</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/gif/img-2.gif" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php"
                                                            class="link-dark">Long-tailed Macaque</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/img-04.jpg" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php" class="link-dark">Robotic
                                                            Body Art</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/img-06.jpg" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php"
                                                            class="link-dark">Smillevers Crypto</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/gif/img-5.gif" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php" class="link-dark">The
                                                            Chirstoper</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/gif/img-3.gif" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php" class="link-dark">Walking
                                                            On Air</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                    <div class="d-flex align-items-center">
                                                        <img src="assets/images/nft/img-04.jpg" alt=""
                                                            class="avatar-xs rounded-circle object-cover me-2"> <a
                                                            href="apps-nft-item-details.php"
                                                            class="link-dark">Highstreet IHO Part</a>
                                                    </div>
                                                </td>
