...
<head>
    ...
    <title>To Do Lists | Velzon - Admin & Dashboard Template</title>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                                ...
                                <ul class="to-do-menu list-unstyled" id="projectlist-data">
                                    <li>
                                        <a data-bs-toggle="collapse" href="#velzonAdmin"
                                            class="nav-link fs-14 active">Velzon Admin & Dashboard</a>
                                    ...
                                    <li>
                                        <a data-bs-toggle="collapse" href="#projectManagement"
                                            class="nav-link fs-14">Project Management</a>
                                    ...
                                    <li>
                                        <a data-bs-toggle="collapse" href="#skoteAdmin" class="nav-link fs-14">Skote
                                            Admin & Dashboard</a>
                                    ...
                                    <li>
                                        <a data-bs-toggle="collapse" href="#ecommerceProject"
                                            class="nav-link fs-14">Doot - Chat App Template</a>
                    ...
                    <div class="file-manager-content w-100 p-4 pb-0">
                        <div class="hstack mb-4">
                            <h5 class="fw-semibold flex-grow-1 mb-0">Velzon Admin & Dashboard <span
                                    class="badge bg-primary align-bottom ms-2">v1.7.0</span></h5>
                            <div class="hstack gap-2">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button class="btn btn-icon fw-semibold shadow-none btn-soft-danger"><i
                                            class="ri-arrow-go-back-line"></i></button>
                                    <button class="btn btn-icon fw-semibold shadow-none btn-soft-success"><i
                ...
                <div class="modal fade zoomIn" id="createProjectModal" tabindex="-1"
                            ...
                            <div class="modal-body">
                                <div>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="button" class="btn btn-primary" id="addNewProject">Add
                                            Project</button>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="createTask" tabindex="-1" aria-labelledby="createTaskLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                                ...
                                <form autocomplete="off" action="" id="creattask-form">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div class="select-element">
                                            <button class="btn btn-light w-100 d-flex justify-content-between"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="date" id="task-duedate-input" class="form-control"
