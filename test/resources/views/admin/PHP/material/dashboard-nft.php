                                        ...
                                        <div class="row g-0">
                                            <div class="col-xxl-8">
                                                <div class="">
                                                    <div class="card-header border-0 align-items-center d-flex">
                                                        ...
                                                        <div>
                                                            <button type="button"
                                                                class="btn btn-soft-secondary shadow-none btn-sm">
                                                                ALL
                                                            </button>
                                                            <button type="button"
                                                                class="btn btn-soft-secondary shadow-none btn-sm">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-soft-primary shadow-none btn-sm">
                                                                1Y
                                                            </button>
                                                        </div>
                                                    </div><!-- end card header -->
                                                    ...
                                                    <div id="line_chart_basic"
                                                        data-colors='["--vz-primary","--vz-success", "--vz-gray-300"]'
                                            ...
                                            <div class="col-xxl-4">
                                                <div class="border-start p-4 h-100 d-flex flex-column">
                                                    ...
                                                    <div class="w-100">
                                                        <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/gif/img-2.gif"
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php">Walking On Air</a>
                                            </h5>
                                            <p class="text-muted mb-0">Artwork</p>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php">Filtered Portrait</a>
                                            </h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php">Patterns Arts &
                                                    Culture</a></h5>
                                            <p class="text-muted mb-0">Artwork</p>
                                        </div>
                                        <div class="card-footer border-top border-top-dashed">
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php">Evolved Reality</a>
                                            </h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <a href="#!">
                                                                    <h6 class="fs-15 mb-1">Coin Journal is dedicated
                                                                    </h6>
                                                                </a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <a href="#!">
                                                                    <h6 class="fs-15 mb-1">Cryptocurrency Price Bitcoin
                                                                    </h6>
                                                                </a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <a href="#!">
                                                                    <h6 class="fs-15 mb-1">Dash, Ripple and Litecoin
                                                                    </h6>
                                                                </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a
                                                                    href="apps-nft-item-details.php">Abstract Face
                                                                    Painting</a></h6>
                                                            <p class="text-muted mb-0"> Artworks</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><img src="assets/images/svg/crypto-icons/btc.svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a
                                                                    href="apps-nft-item-details.php">Long-tailed
                                                                    Macaque</a></h6>
                                                            <p class="text-muted mb-0">Games</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><img src="assets/images/svg/crypto-icons/ltc.svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a
                                                                    href="apps-nft-item-details.php">Robotic Body
                                                                    Art</a></h6>
                                                            <p class="text-muted mb-0">Photography</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><img src="assets/images/svg/crypto-icons/etc.svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a
                                                                    href="apps-nft-item-details.php">Smillevers
                                                                    Crypto</a></h6>
                                                            <p class="text-muted mb-0">Artworks</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><img src="assets/images/svg/crypto-icons/dash.svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a
                                                                    href="apps-nft-item-details.php">Creative Filtered
                                                                    Portrait</a></h6>
                                                ...
                                                <td><img src="assets/images/svg/crypto-icons/bnb.svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a href="apps-nft-item-details.php">The
                                                                    Chirstoper</a></h6>
                                                            <p class="text-muted mb-0"> Crypto Card</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><img src="assets/images/svg/crypto-icons/usdt.svg"
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                ...
                                <div id="creators-by-locations"
                                    data-colors='["--vz-gray-200", "--vz-success", "--vz-primary"]'
                                ...
                                <div class="mt-1">
                                    ...
                                    <p class="mb-0"><img src="assets/images/flags/germany.svg" alt="" height="15"
                                            class="rounded me-2"> Germany <span class="float-end">5%</span></p>
                                </div>
                            </div>
                            <!-- end card body -->
                        </div>
                    ...
                    <div class="col-xxl-3 col-lg-6">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <a href="apps-nft-collections.php" type="button"
                                    class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
                                    See All <i class="ri-arrow-right-line align-bottom"></i>
                                </a>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <a href="apps-nft-creators.php" type="button"
                                    class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
                                    See All <i class="ri-arrow-right-line align-bottom"></i>
                                </a>
                            </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-14"></i> 81,369 ETH
                                                    </p>
                                                </div>
                                                <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-14"></i> 4,754 ETH
                                                    </p>
                                                </div>
                                                <div>
                                                    <div class="dropdown float-end">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-14"></i> 68,945 ETH
                                                    </p>
                                                </div>
                                                <div>
                                                    <div class="dropdown float-end">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-14"></i> 49,031 ETH
                                                    </p>
                                                </div>
                                                <div>
                                                    <div class="dropdown float-end">
