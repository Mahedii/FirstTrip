                                                    ...
                                                    <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner text-center text-white pb-5">
                                                            <div class="carousel-item active">
                                                                <p class="fs-15 fst-italic">" Internationally certified. "</p>
                                                            </div>
                                                ...
                                                <form method="POST" action="{{ route('user.signin') }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                            <input type="password" class="form-control @error('password') is-invalid @enderror pe-5" placeholder="Enter password" value="{{ old('password') }}" name="password" id="password">
