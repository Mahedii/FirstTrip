                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    @foreach($ourServiceData as $data)

                                        <form method="POST" action="{{ route('our.service.list.update',$data->SLUG) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="previewFile"> 
                                                        ...
                                                        <img src="{{ asset($data->FILE_PATH) }}" alt="{{ $data->TITLE }}" height="60px">
