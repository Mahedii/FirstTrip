                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    ...
                                    @foreach($customerData as $data)
                                        ...
                                        <form method="POST" action="{{ route('customers.update',$data->SLUG) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="customerNameInput" class="form-label">Customer Name</label>
                                                        <input type="text" class="form-control @error('customerNameInput') is-invalid @enderror" placeholder="Customer name" value="{{ $data->CUSTOMER_NAME }}" name="customerNameInput">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="previewFile"> 
                                                        <img src="{{ asset($data->FILE_PATH) }}" alt="$data->CUSTOMER_NAME">
                                                    </div>
                                                </div><!--end col-->
