                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Edit Service Data</h4>
                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Edit Service Data</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    @foreach($servicePageData as $data)
                                        ...
                                        <form method="POST" action="{{ route('service.page.tab.update',$data->SLUG) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('ICON') is-invalid @enderror" value="{{ $data->ICON }}" name="ICON">
                                                        @if ($errors->has('ICON'))
