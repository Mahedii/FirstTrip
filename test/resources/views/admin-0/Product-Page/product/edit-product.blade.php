                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            @foreach($productData as $productData)
                                ...
                                <form method="POST" action="{{ route('product.update', $productData->SLUG) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('productNameInput') is-invalid @enderror" placeholder="Product name" value="{{ $productData->PRODUCT_NAME }}" name="productNameInput">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div>
                                                                ...
                                                                <select class="form-select mb-3" id="select-category" name="categoryNameInput">
                                                                    ...
                                                                    <option value="{{ $productData->CATEGORY_ID }}" selected>{{ $productData->CATEGORY_NAME }}</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div>
                                                                ...
                                                                <select class="form-select mb-3" id="select-subcategory" data-placeholder="Choose One" name="subcategoryNameInput">
                                                                    ...
                                                                    <option value="{{ $productData->SUBCATEGORY_ID }}" selected>{{ $productData->SUBCATEGORY_NAME }}</option>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            ...
                                                            <div class="preview-image-before-upload"> 

                                                                <a href="">
                                                                    <img src="{{ asset($productData->FILE_PATH) }}" height="100px" width="100px" alt="">
                                                                </a>
