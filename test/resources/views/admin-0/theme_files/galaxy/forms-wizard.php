...
<head>
    ...
    <title>Wizard | Velzon - Admin & Dashboard Template</title>
                                        ...
                                        <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link rounded-pill"
                                                    ...
                                                    role="tab" aria-controls="pills-success"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="gen-info-email-input" placeholder="Enter Email">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="tab-pane fade" id="v-pills-finish" role="tabpanel"
                                                        ...
                                                        <div class="text-center pt-4 pb-2">
                                                            ...
                                                            <p class="text-muted">You Will receive an order confirmation
                                                                email with details of your order.</p>
                                                        </div>
                                                    </div>
                                                    <!-- end tab pane -->
                                                </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <h5 class="fs-14 text-primary mb-0"><i
                                                        class="ri-shopping-cart-fill align-middle me-2"></i> Your cart
                                                </h5>
