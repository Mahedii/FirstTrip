                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with
                                <span class="text-primary">Velzon </span></h1>
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4">
                                <a href="auth-signup-basic.php" class="btn btn-primary">Get Started <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></a>
                                <a href="pages-pricing.php" class="btn btn-soft-primary">View Plans <i
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="text-muted">
                            <h5 class="fs-12 text-uppercase text-primary">Design</h5>
                            ...
                            <div class="mt-4">
                                <a href="index.php" class="btn btn-primary">Learn More <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center mt-5 pt-lg-5 gy-4">
                    ...
                    <div class="col-lg-6">
                        <div class="text-muted ps-lg-5">
                            <h5 class="fs-12 text-uppercase text-primary">structure</h5>
                        ...
                        <div class="card plan-box mb-0">
                            <div class="card-body p-4 m-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <a href="javascript:void(0);" class="btn btn-soft-primary w-100">Get Started</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mb-5">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <button type="button" class="btn btn-primary btn-label rounded-pill"><i
                                    ...
                                    Us</button>
                                <button type="button" class="btn btn-soft-secondary btn-label rounded-pill"><i
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                                <div class="text-white-50">
                                                    <p class="fs-20 ff-secondary mb-4">" Awesome support. Had few issues
                                                        while setting up because of my device, the support team helped
                                                        me fix them up in a day. Everything looks clean and good. Highly
                                                        recommended! "</p>
        ...
        <section class="section bg-light" id="team">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h3 class="mb-3 fw-semibold">Our <span class="text-primary">Team</span></h3>
                        ...
                        <div class="card">
                            <div class="card-body text-center p-4">
                                <div class="avatar-xl mx-auto mb-4 position-relative">
                                    ...
                                    <a href="apps-mailbox.php"
                                        class="btn btn-primary btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Nancy Martino</a></h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Henry Baird</a></h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Frank Hook</a></h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Donald Palmer</a></h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Erica Kernan</a></h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Alexis Clarke</a></h5>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Marie Ward</a></h5>
                                <p class="text-muted mb-0 ff-secondary">Full Stack Developer</p>
                            </div>
                        </div>
                        <!-- end card -->
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.php" class="text-body">Jack Gough</a></h5>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-2">
                            <a href="pages-team.php" class="btn btn-primary">View All Members <i
