        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="apps-nft-wallet.php" class="btn btn-primary">Wallet Connect</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            <h1 class="display-4 fw-medium mb-4 lh-base text-white">Discover Digital Art & Collect <span
                                    class="text-primary">NFT Marketplace</span></h1>
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <a href="apps-nft-create.php" class="btn btn-primary">Create Own <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></a>
                                <a href="apps-nft-explore.php" class="btn btn-secondary">Explore Now <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                ...
                                <a href="#!" class="btn btn-primary">Change Wallet</a>
                            </div>
                        </div>
                    </div>
                    <!-- end col -->
                    ...
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Creative Filtered Portrait</a>
                                </h5>
                        ...
                        <div class="card shadow-none">
                            <div class="card-body">
                                ...
                                <p class="text-muted fs-14">You have to choose whether to use a hot wallet a cold
                                    wallet.</p>
                                <a href="#!" class="link-primary fs-14">Read More <i
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <a href="apps-nft-explore.php" class="btn btn-primary">View All <i
                                    class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div>
                </div><!-- end row -->
                ...
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            ...
                            <a href="apps-nft-explore.php" class="btn bg-gradient btn-primary">Discover More</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
