...
<head>
    ...
    <title>Live Auction | Velzon - Admin & Dashboard Template</title>
                                        ...
                                        <ul class="nav nav-pills filter-btns" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link fw-medium" type="button"
                                                    data-filter="upto-15">Up to 15%</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link fw-medium" type="button"
                                                    data-filter="upto-30">Up to 30%</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link fw-medium" type="button"
                                                    data-filter="upto-40">Up to 40%</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Abstract Face
                                                Painting</a></h6>
                                        <div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Patterns Arts &
                                                Culture</a></h6>
                                        <div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Creative Filtered
                                                Portrait</a></h6>
                                        <div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Smillevers
                                                Crypto</a></h6>
                                        <div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Long-tailed
                                                Macaque</a></h6>
                                        <div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">The Chirstoper</a>
                                        </h6>
                                        <div>
                                            ...
                                            <div class="progress progress-sm mt-2">
                                                <div class="progress-bar progress-bar-striped bg-warning"
                                                    role="progressbar" style="width: 83%;" aria-valuenow="83"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Robotic Body Art</a>
                                        </h6>
                                        <div>
                                            ...
                                            <div class="progress progress-sm mt-2">
                                                <div class="progress-bar progress-bar-striped bg-primary"
                                                    role="progressbar" style="width: 24%;" aria-valuenow="24"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                <div class="card explore-box card-animate">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                        <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Evolved Reality</a>
                                        </h6>
                                        <div>
                                            ...
                                            <div class="progress progress-sm mt-2">
                                                <div class="progress-bar progress-bar-striped bg-danger"
                                                    role="progressbar" style="width: 97%;" aria-valuenow="97"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-borderless align-middle">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-soft-primary btn-sm">Unfllow</button></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
