...
<head>
    ...
    <title>Sellers | Velzon - Admin & Dashboard Template</title>
                            ...
                            <div class="col-lg-auto">
                                <div class="hstack gap-2">
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#addSeller"><i class="ri-add-fill me-1 align-bottom"></i> Add
                                        Seller</button>
                                </div>
                            </div>
                            <!--end col-->
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card ribbon-box right overflow-hidden">
                            <div class="card-body text-center p-4">
                                <div class="ribbon ribbon-primary ribbon-shape trending-ribbon"><i
                                ...
                                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php"
                                        class="link-primary">Force Medicines</a></h5>
                                ...
                                <div class="mt-4">
                                    <a href="apps-ecommerce-seller-details.php" class="btn btn-light w-100">View
                                        Details</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php"
                                        class="link-primary">Micro Design</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php"
                                        class="link-primary">Nesta Technologies</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card ribbon-box right overflow-hidden">
                            <div class="card-body text-center p-4">
                                ...
                                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php"
                                        class="link-primary">iTest Factory</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card ribbon-box right overflow-hidden">
                            <div class="card-body text-center p-4">
                                ...
                                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php"
                                        class="link-primary">Syntyce Solutions</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php"
                                        class="link-primary">Zoetic Fashion</a></h5>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            id="contactnumberInput" placeholder="Enter your number">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                    ...
                                    <div class="tab-pane" id="businessDetails" role="tabpanel">
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="pancardInput" class="form-label">Pan Card
                                                            Number</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="accountnumberInput" class="form-label">Account
                                                            Number</label>
                                                        <input type="number" class="form-control"
                                                            id="accountnumberInput" placeholder="Enter account number">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
