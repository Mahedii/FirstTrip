                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <p class="mb-0 text-muted"><span class="badge bg-soft-danger text-danger mb-0">
                                                <i class="ri-arrow-down-line align-middle"></i> 0.96 % </span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <p class="mb-0 text-muted"><span class="badge bg-soft-danger text-danger mb-0">
                                                <i class="ri-arrow-down-line align-middle"></i> 3.87 % </span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <p class="mb-0 text-muted"><span
                                                class="badge bg-soft-success text-success mb-0"> <i
                                                    class="ri-arrow-up-line align-middle"></i> 1.09 % </span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="table-responsive table-card mb-4">
                                        ...
                                        <tbody class="list form-check-all" id="ticket-list-data">
                                            <tr>
                                                ...
                                                <td class="status"><span
                                                        class="badge badge-soft-warning text-uppercase">Inprogress</span>
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><button class="dropdown-item"
                                                                    onclick="location.href = 'apps-tickets-details.php';"><i
                                    ...
                                    <div class="noresult" style="display: none">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-0">We've searched more than 150+ Tickets We did not
                                                find any Tickets for you search.</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" id="date-field" class="form-control"
                                                data-provider="flatpickr" data-date-format="d M, Y"
                                                placeholder="Create Date" required />
                                        </div>
                                        <div class="col-lg-6">
