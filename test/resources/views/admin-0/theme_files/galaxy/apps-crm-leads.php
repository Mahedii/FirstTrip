                                    ...
                                    <div class="table-responsive table-card">
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="text-center">
                                                ...
                                                <p class="text-muted mb-0">We've searched more than 150+ leads We did
                                                    not find any leads for you search.</p>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div>
                                                                ...
                                                                <input type="text" id="leads_score-field"
                                                                    class="form-control" placeholder="Enter lead score"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <!--end col-->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <p class="text-muted fs-14 mb-4 pt-1">Deleting your lead will remove
