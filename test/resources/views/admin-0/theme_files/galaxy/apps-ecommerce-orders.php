                                ...
                                <div class="card-header  border-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            <button class="btn btn-soft-primary" onClick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-nowrap align-middle" id="orderTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="id"><a href="apps-ecommerce-order-details.php" class="fw-medium link-primary">#VZ2101</a></td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                                    <a href="apps-ecommerce-order-details.php" class="text-primary d-inline-block">
