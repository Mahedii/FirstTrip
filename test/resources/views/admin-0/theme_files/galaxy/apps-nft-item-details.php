...
<head>
    ...
    <title>Item Details | Velzon - Admin & Dashboard Template</title>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-8">
                                <div>
                                    ...
                                    <span class="badge badge-soft-primary mb-3 fs-12"><i
                                            class="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                    <h4>Patterns Arts & Culture</h4>
                                    <div class="hstack gap-3 flex-wrap">
                                        <div class="text-muted">Creators : <a href="#"
                                                class="text-primary fw-medium">Nancy Martino</a></div>
                                        <div class="vr"></div>
                                        <div class="text-muted">Seller : <span class="text-body fw-medium">Rickey
                                                Teran</span></div>
                                        <div class="vr"></div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="p-2 border border-dashed rounded text-center">
                                                <div>
                                                    ...
                                                    <h5 class="fs-17 text-primary mb-0"><i
                                                            class="mdi mdi-ethereum me-1"></i> 83.06 ETH</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end col -->
                                    ...
                                    <div class="mt-4 text-muted">
                                        ...
                                        <p>Cultural patterns are the similar behaviors within similar situations we
                                            witness due to shared beliefs, values, norms and social practices that are
                                            steady over time. In art, a pattern is a repetition of specific visual
                                            elements. The dictionary.com definition of "pattern" is: an arrangement of
                                                    ...
                                                    <table class="table align-middle table-nowrap mb-0">
                                                        <tbody>
                                                                ...
                                                                <th scope="row">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <a href="apps-nft-item-details.php"
                                                                            class="link-dark"><span
                                                                                class="mb-0 ms-2">Brave Tigers
                                                                                NFT</span></a>
                                                                    </div>
                                                                </th>
                                                                <td>0.235 ETH</td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <a href="apps-nft-item-details.php"
                                                                            class="link-dark"><span
                                                                                class="mb-0 ms-2">Creative filtered
                                                                                portrait</span></a>
                                                                    </div>
                                                                </th>
                                                                <td>571.24 ETH</td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div class="d-flex align-items-center">
                                                                        <img src="assets/images/nft/gif/img-4.gif"
                                                                            alt=""
                                                                            class="avatar-xs rounded object-cover" />
                                                                        <a href="apps-nft-item-details.php"
                                                                            class="link-dark"><span
                                                                                class="mb-0 ms-2">Evolved
                                                                                Reality</span></a>
                                                                    </div>
                                                                </th>
                                                                <td>130.39 ETH</td>
                                                    ...
                                                    <div class="pb-3">
                                                        ...
                                                        <div class="text-center">
                                                            <div class="text-muted">Total <span
                                                                    class="fw-medium">7.32k</span> reviews
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col">
                                                                <div class="p-2">
                                                                    <div class="progress animated-progress progress-sm">
                                                                        <div class="progress-bar bg-priamry"
