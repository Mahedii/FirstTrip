                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            ...
                                            <div class="mt-3">
                                                <a href="pages-pricing.php" class="btn btn-primary">Upgrade
                                                    Account!</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            <p class="fs-16 lh-base text-white">Upgrade your plan from a <span
                                                    ...
                                                    class="mdi mdi-arrow-right"></i></p>
                                            <div class="mt-3">
                                                <a href="pages-pricing.php" class="btn btn-info">Upgrade Account!</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="alert alert-primary border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="pages-pricing.php" class="text-reset text-decoration-underline"><b>Get
                                                Free Gift</b></a>
                                    </div>
                                </div>
                                <div class="d-flex p-3">
                                    ...
                                    <div>
                                        <p class="fs-16 lh-base">Personalized <span class="fw-semibold">Gift
                                                ...
                                                class="mdi mdi-arrow-right"></i></p>
                                        <div class="mt-3">
                                            <a href="pages-pricing.php" class="btn btn-primary">Get a Free Gift</a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end card-body-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-evenly">
                                    ...
                                    <p class="text-muted mb-0">
                                        <i class="mdi mdi-numeric-3-circle text-info fs-18 align-middle me-2"></i>In
                                        Progress
                                    </p>
                                            ...
                                            <ul class="list-group list-group-flush border-dashed px-3">
                                                ...
                                                <li class="list-group-item ps-0">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <label class="form-check-label mb-0 ps-2"
                                                                for="task_three">Weekly closed sales won checking with
                                                                sales team</label>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                ...
                                                <li class="list-group-item ps-0">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <label class="form-check-label mb-0 ps-2"
                                                                for="task_four">Add notes that can be viewed from the
                                                                individual view</label>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted mb-2"><span class="text-danger">
                                                                2 days left</span> notification to submit the monthly
                    ...
                    <div class="col-xxl-4">
                        <div class="card card-height-100">
                            ...
                            <div class="card-header p-0">
                                <div class="alert alert-primary alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center"
                                    role="alert">
                                    <i class="ri-error-warning-line label-icon"></i>
                                    <div class="flex-grow-1 text-truncate">
                                        Your free trial expired in <b>17</b> days.
