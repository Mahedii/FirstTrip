...
<head>
    ...
    <title>Creators | Velzon - Admin & Dashboard Template</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-sm-auto">
                        <div>
                            <a href="apps-projects-create.php" class="btn btn-primary"><i
                ...
                <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-03.jpg" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted">You can make an NFT of a digital painting, a text, a piece of
                                    music, a video.</p>
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/gif/img-2.gif" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-05.jpg" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/nft/img-06.jpg" alt=""
                                    class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-06.jpg" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/gif/img-3.gif" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/users/avatar-8.jpg" alt=""
                                    class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-01.jpg" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/nft/gif/img-1.gif" alt=""
                                    class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/gif/img-4.gif" alt="" class="object-cover card-img-top"
                                height="120">
                            <div class="card-body text-center">
