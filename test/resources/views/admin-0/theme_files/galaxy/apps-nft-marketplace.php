        ...
        <div class="page-content">
            <div class="container-fluid">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-1 mb-3">
                                            <div class="col-lg-6">
                                                ...
                                                <img src="assets/images/nft/gif/img-1.gif" alt=""
                                                    class="img-fluid rounded mt-1">
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                                                <img src="assets/images/nft/gif/img-4.gif" alt=""
                                        ...
                                        <div class="row g-1 mb-3">
                                            <div class="col-lg-6">
                                                <img src="assets/images/nft/img-06.jpg" alt=""
                                                    class="img-fluid rounded">
                                                <img src="assets/images/nft/gif/img-2.gif" alt=""
                                                    class="img-fluid rounded mt-1">
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row g-1 mb-3">
                                            <div class="col-lg-6">
                                                <img src="assets/images/nft/img-02.jpg" alt=""
                                                    class="img-fluid rounded">
                                                <img src="assets/images/nft/gif/img-3.gif" alt=""
                                                    class="img-fluid rounded mt-1">
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-6">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card bg-primary" style="background-image: url('assets/images/nft/bg-pattern.png');">
                            <div class="card-body p-4">
                                ...
                                <p class="text-white-75 mb-3">Take advantage of the first text-based NFT. Select a text
                                    or write your own and let it live forever on the Ethereum blockchain you or future
                                    owners can add text to an existing ChainText token..</p>
                                <div class="hstack gap-2">
                                    <a href="apps-nft-create.php" class="btn btn-secondary">Create NFT</a>
                                    <a href="apps-nft-explore.php" class="btn btn-danger">Explore Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card overflow-hidden shadow-none border-0">
                            <div class="card-body bg-soft-primary text-primary fw-semibold d-flex">
                                <marquee class="fs-14">
                                    NFT art is a digital asset that is collectable, unique, and non-transferrable,
                                    Cortes explained. Every NFT is unique in it's creative design and cannot be
                    ...
                    <div class="col-lg-12">
                        <div class="d-lg-flex align-items-center mb-4">
                            ...
                            <div class="flex-shrink-0 mt-4 mt-lg-0">
                                <a href="apps-nft-explore.php" class="btn btn-soft-primary">View All <i
                                        class="ri-arrow-right-line align-bottom"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Patterns Arts &
                                            Culture</a></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 475.23 ETH </h5>
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Evolved Reality</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 701.38 ETH </h5>
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Long-tailed Macaque</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <p class="fw-medium mb-0 float-end"><i
                                            class="mdi mdi-heart text-danger align-middle"></i> 29.20k </p>
                                    <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 917.83 ETH </h5>
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Robotic Body Art</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card explore-box">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <p class="fw-medium mb-0 float-end"><i
                                            class="mdi mdi-heart text-danger align-middle"></i> 78.34k </p>
                                    <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 571.24 ETH </h5>
                                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Creative Filtered
                                            Portrait</a></h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-lg-flex align-items-center mb-4">
                            ...
                            <div class="flex-shrink-0 mt-4 mt-lg-0">
                                <a href="apps-nft-creators.php" class="btn btn-soft-primary">View All <i
                                        class="ri-arrow-right-line align-bottom"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">The Chirstoper</a></h5>
                    ...
                    <div class="col">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Trendy Fashion Portraits</a></h5>
                            ...
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 fs-14">
                                        <i class="ri-price-tag-3-fill text-warning align-bottom me-1"></i> Highest:
                                        <span class="fw-medium">674.92 ETH</span>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Smillevers Crypto</a></h5>
                    ...
                    <div class="col">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Evolved Reality</a></h5>
                    ...
                    <div class="col">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php">Abstract Face Painting</a></h5>
                ...
                <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-03.jpg" alt="" class="card-img-top object-cover"
                                height="120">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/gif/img-5.gif" alt="" class="card-img-top object-cover"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/nft/img-04.jpg" alt=""
                                    class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-01.jpg" alt="" class="card-img-top object-cover"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/nft/img-06.jpg" alt=""
                                    class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-05.jpg" alt="" class="card-img-top object-cover"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/nft/gif/img-2.gif" alt=""
                                    class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                    ...
                    <div class="col">
                        <div class="card">
                            <img src="assets/images/nft/img-02.jpg" alt="" class="card-img-top object-cover"
                                height="120">
                            <div class="card-body text-center">
                                <img src="assets/images/nft/gif/img-1.gif" alt=""
                                    class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
