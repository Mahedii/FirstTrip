                                    ...
                                    <li>
                                        <a data-bs-toggle="collapse" href="#collapseExample" role="button"
                                            ...
                                            <i class="ri-folder-2-line align-bottom me-2"></i> <span
                                                class="file-list-link">My Drive</span>
                                        </a>
                        ...
                        <div class="mx-n3 pt-4 px-4 file-manager-content-scroll" data-simplebar>
                                ...
                                <div class="row justify-content-beetwen g-2 ">
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex gap-2 align-items-start">
                                            ...
                                            <button class="btn btn-primary w-sm create-folder-modal"
                            ...
                            <div>
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="flex-shrink-0">
                                        <button class="btn btn-primary createFile-modal" data-bs-toggle="modal"
                                            data-bs-target="#createFileModal"><i
                                                class="ri-add-line align-bottom me-1"></i> Create File</button>
                                    </div>
                                </div>
                        ...
                        <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" data-simplebar>
                            <div id="folder-overview">
                                ...
                                <div id="simple_dount_chart"
                                    data-colors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.40"]'
