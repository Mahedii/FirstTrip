                                        ...
                                        <ul class="list list-group list-group-flush mb-0">
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 mb-1"><a href="#"
                                                                class="link name text-dark">Jonny Stromberg</a></h5>
                                                        <p class="born timestamp text-muted mb-0"
                                                            data-timestamp="12345">1986</p>
                                                    </div>
                                            ...
                                            <li class="list-group-item" data-id="2">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 mb-1"><a href="#"
                                                                class="link name text-dark">Jonas Arnklint</a></h5>
                                                        <p class="born timestamp text-muted mb-0"
                                                            data-timestamp="23456">1985</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div>
                                                            <img class="image avatar-xs rounded-circle" alt=""
                                            ...
                                            <li class="list-group-item" data-id="3">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 mb-1"><a href="#"
                                                                class="link name text-dark">Martina Elm</a></h5>
                                                        <p class="born timestamp text-muted mb-0"
                                                            data-timestamp="34567">1986</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div>
                                                            <img class="image avatar-xs rounded-circle" alt=""
                                            ...
                                            <li class="list-group-item" data-id="4">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 mb-1"><a href="#"
                                                                class="link name text-dark">Gustaf Lindqvist</a></h5>
                                                        <p class="born timestamp text-muted mb-0"
                                                            data-timestamp="45678">1983</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <div>
                                                            <img class="image avatar-xs rounded-circle" alt=""
                                        ...
                                        <ul class="list list-group list-group-flush mb-0">
                                                ...
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                                class="link text-dark">Jonny Stromberg</a></h5>
                                                        <p class="contact-born text-muted mb-0">New updates for ABC
                                                            Theme</p>
                                                    </div>
                                            ...
                                            <li class="list-group-item" data-id="02">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                                class="link text-dark">Jonas Arnklint</a></h5>
                                                        <p class="contact-born text-muted mb-0">Bug Report - abc theme
                                                        </p>
                                                    </div>
                                                    <div class="flex-shrink-0 ms-2">
                                            ...
                                            <li class="list-group-item" data-id="03">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                                class="link text-dark">Martina Elm</a></h5>
                                            ...
                                            <li class="list-group-item" data-id="04">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="contact-name fs-13 mb-1"><a href="#"
                                                                class="link text-dark">Gustaf Lindqvist</a></h5>
                                                        <p class="contact-born text-muted mb-0">I've finished it! See
                                                            you so</p>
                                                    </div>
                                                    <div class="flex-shrink-0 ms-2">
                                                ...
                                                <div class="d-flex align-items-center pagi-list">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="fs-13 mb-1"><a href="#" class="link text-dark">Jonny
                                                                Stromberg</a></h5>
                                                        <p class="born timestamp text-muted mb-0">Front end Developer
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div>
                                                            <button type="button" class="btn btn-sm btn-light"><i
                                                                    class="ri-mail-line align-bottom"></i>
                                                                Message</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center pagi-list">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="fs-13 mb-1"><a href="#" class="link text-dark">Jonas
                                                                Arnklint</a></h5>
                                                        <p class="born fs-12 timestamp text-muted mb-0">Backend
                                                            Developer</p>
                                                    </div>
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center pagi-list">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 mb-1"><a href="#"
                                                                class="link text-dark">Martina Elm</a></h5>
                                                        <p class="born fs-12 timestamp text-muted mb-0">UI/UX Designer
                                                        </p>
                                                    </div>
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center pagi-list">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 mb-1"><a href="#" class="link text-dark">Gustaf
                                                                Lindqvist</a></h5>
                                                        <p class="born fs-12 timestamp text-muted mb-0">Full Stack
                                                            Developer</p>
                                                    </div>
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div>
