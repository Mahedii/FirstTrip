        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Update About Page Data</h4>
                ...
                <div class="row">
                    ...
                    @foreach($aboutPageData as $data)
                    
                        <form method="POST" action="{{ route('about.page.section.update', $data->SLUG) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm">
                                        <div class="d-flex justify-content-sm-end">
                                            <a href="{{ route('about.page.tab.addPage') }}" class="btn btn-success">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">Tab Lists</h5>
                            </div>
                            ...
                            <div class="card-body">
                                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($aboutPageDataList as $key => $data)
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('about.page.tab.editpage.load',$data->SLUG) }}" class="dropdown-item edit-item-btn">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('about.page.tab.delete',$data->SLUG) }}" class="dropdown-item edit-item-btn">
