        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    @foreach ($packageCountryData as $packageCountry)

                    <form method="POST" action="{{ route('destination.country.update',$packageCountry->SLUG) }}" enctype="multipart/form-data" id="tourPackageForm">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('COUNTRY_NAME') is-invalid @enderror" value="{{ $packageCountry->COUNTRY_NAME }}" name="COUNTRY_NAME">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="preview-image-before-upload mb-3">
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset($packageCountry->FILE_PATH) }}" height="150px" width="200px" alt="">
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                ...
                                <div class="text-end mb-3">
                                    <button type="submit" class="btn btn-success w-sm">Update Country</button>
                                </div>
                            </div>
                            <!-- end col -->
