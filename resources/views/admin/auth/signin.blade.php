                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4 auth-one-bg h-100">
                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <a href="{{ Route('home.data') }}" class="d-block">
                                                    ...
                                                    <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner text-center text-white pb-5">
                                                            <div class="carousel-item active">
                                                                <p class="fs-15 fst-italic">" Our factories are mostly BSCI and Oekotex certified. "</p>
                                                            </div>
                                                            <div class="carousel-item">
                                                                <p class="fs-15 fst-italic">" High-energy team motivation and an environment that promotes productivity."</p>
                                                            </div>
                                                            <div class="carousel-item">
                                                                <p class="fs-15 fst-italic">" Always aim to routinely update outdated technology with the most modern. "</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end carousel -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            <div>
                                                ...
                                                <p class="text-muted">Sign in to continue to Masstyles.</p>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0">&copy; <script>document.write(new Date().getFullYear())</script> Masstyles. Made by <a target="_blank" href="https://www.moonitzone.com" style="color:white">Moon IT Zone</a></p>
                            </div>
                        </div>
                    </div>
                </div>
