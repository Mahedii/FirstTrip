                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach($pageData as $page)
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="FAQ_PAGE" class="form-label">Page Contents <span class="text-danger">*</span></label>
                                                        <p class="text-muted mb-2">Edit page contents</p>
                                                        <textarea class="form-control" id="ckeditor-classic" name="FAQ_PAGE" rows="5">{{ $page->FAQ_PAGE }}</textarea>
                                                        @if ($errors->has('FAQ_PAGE'))
                                                            <span class="text-danger">{{ $errors->first('FAQ_PAGE') }}</span>
                                                        @endif
                                                    </div>
                                                </div><!--end col-->
