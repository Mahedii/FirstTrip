    ...
    @section('content')
        ...
        <section class="page-header">
            <div class="page-header__top">
               <div class="page-header-bg" style="background-image: url(frontend/assets/images/backgrounds/page-header-bg.jpg)"></div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="destinations-details__left">
                            <div class="destinations-details__img">
                                <img src="{{asset('frontend/assets/images/resources/destinations-details-img-1.jpg')}}" alt="">
                            </div>
                            <div class="destinations-details__discover">
                                <h3 class="destinations-details__title">Discover Spain</h3>
                                <p class="destinations-details__discover-text-1">Lorem ipsum available isn but the majority have suffered alteratin in some or form injected. Lorem Ipsum. Proin gravida nibh vel velit auctor aliqueenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. vulputate cursus a sit amet mauris. Morbi accumsan ipsum veliam nec tellus a odio tincidunt auctor.</p>
                                <p class="destinations-details__discover-text-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some injected or  words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary,</p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="destinations-details__right">
                                ...
                                <ul class="tour-details-two__last-minute-list list-unstyled">
                                    <li>
                                        <div class="tour-details-two__last-minute-image">
                                            <img src="{{asset('frontend/assets/images/resources/td-img-1.jpg')}}" alt="">
                                        </div>
                                    ...
                                    <li>
                                        <div class="tour-details-two__last-minute-image">
                                            <img src="{{asset('frontend/assets/images/resources/td-img-2.jpg')}}" alt="">
                                        </div>
                                        <div class="tour-details-two__last-minute-content">
                                            <h6>$380</h6>
                                            <h5>Africa 2 Days Tour</h5>
                                    ...
                                    <li>
                                        <div class="tour-details-two__last-minute-image">
                                            <img src="{{asset('frontend/assets/images/resources/td-img-3.jpg')}}" alt="">
                                        </div>
                                        <div class="tour-details-two__last-minute-content">
                                            <h6>$380</h6>
                                            <h5>Africa 2 Days Tour</h5>
                            ...
                            <div class="destinations-details__discount">
                                <img src="{{asset('frontend/assets/images/resources/destinations-details__discount-img.jpg')}}" alt="">
